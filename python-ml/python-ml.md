...
[![GitHub forks](https://img.shields.io/github/forks/miarchitect/Machine-Learning-with-Python.svg)](https://github.com/miarchitect/Machine-Learning-with-Python/network)
[![GitHub stars](https://img.shields.io/github/stars/miarchitect/Machine-Learning-with-Python.svg)](https://github.com/miarchitect/Machine-Learning-with-Python/stargazers)

# Python Machine Learning Notebooks (Tutorial style)

### Dr. miarchitect (Maneesh Innani ), Fremont, CA ([Please feel free to add me on LinkedIn here](https://www.linkedin.com/in/miarchitect-(Maneesh Innani )-2127aa7))
---
...
* **[Basics of Numpy array](https://github.com/miarchitect/PythonMachineLearning/blob/master/Pandas%20and%20Numpy/Basics%20of%20Numpy%20arrays.ipynb)**
* **[Basics of Pandas DataFrame](https://github.com/miarchitect/PythonMachineLearning/blob/master/Pandas%20and%20Numpy/Basics%20of%20Pandas%20DataFrame.ipynb)**
* **[Basics of Matplotlib and Descriptive Statistics](https://github.com/miarchitect/PythonMachineLearning/blob/master/Pandas%20and%20Numpy/Basics%20of%20Matplotlib%20and%20Descriptive%20Statistics.ipynb)**
...
* [Multiple ways to perform linear regression in Python and their speed comparison](https://github.com/miarchitect/Machine-Learning-with-Python/blob/master/Regression/Linear_Regression_Methods.ipynb) ([check the article I wrote on freeCodeCamp](https://medium.freecodecamp.org/data-science-with-python-8-ways-to-do-linear-regression-and-measure-their-speed-b5577d75f8b))

* [Multi-variate regression with regularization](https://github.com/miarchitect/Machine-Learning-with-Python/blob/master/Regression/Multi-variate%20LASSO%20regression%20with%20CV.ipynb)
...
* [Detailed visual analytics and goodness-of-fit diagnostic tests for a linear regression problem](https://github.com/miarchitect/Machine-Learning-with-Python/blob/master/Regression/Regression_Diagnostics.ipynb)
